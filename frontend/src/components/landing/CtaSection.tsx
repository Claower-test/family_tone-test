  ...
  return (
    <section className="py-32 md:py-48 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          Не<br />откладывайте<span className="gradient-text">.</span>
        </motion.h2>
        ...
        >
          <div className="store-badge inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl cursor-pointer">
            ...
            <div className="text-left">
              <p className="text-[8px] text-neutral-400 leading-none">Загрузите в</p>
              <p className="text-xs font-semibold text-neutral-700 leading-tight">App Store</p>
            </div>
          </div>
          <div className="store-badge inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl cursor-pointer">
            <Icon icon="mdi:google-play" className="text-xl text-neutral-400" />
            <div className="text-left">
              <p className="text-[8px] text-neutral-400 leading-none">Доступно в</p>
              <p className="text-xs font-semibold text-neutral-700 leading-tight">Google Play</p>
            </div>
          </div>
        </motion.div>
      </div>
